...
public class HttpUtils {
    ...
    public static String sendGetAndTry(String url) throws Exception {
        int count = 0;
        while (count < 3) {
            count++;
            try {
                ...
                System.out.println(url+":重试"+count+"次");
            }
        }
        throw new Exception();
    }
...
//            System.out.println("recv - {}"+result);
    ...
    public static String sendPost(String url, String param) {
        ...
        try {
            ...
            System.out.println("调用HttpUtils.sendPost SocketTimeoutException, url=" + url + ",param=" + param);
        } catch (IOException e) {
    ...
    public static String sendSSLPost(String url, String param) {
        ...
        try {
            System.out.println("sendSSLPost - {}" + urlNameString);
